            ...
            <div className="modal fade show" style={{ display: 'block' }}>
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="input-group mb-3">
                            <input type="text" className="form-control" placeholder="Mês" value={mes} onChange={(e) => setMes(e.target.value)} />
                        </div>
                        <div class="input-group mb-3">
                        ...
                        <div class="input-group mb-3">
                            <textarea className="form-control" placeholder="Itens do orçamento(CSV):" value={itensOrcamentoCSV} onChange={(e) => setItensOrcamentoCSV(e.target.value)} />
                        </div>
